                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-hover table-nowrap card-table">
                            ...
                            <tr>
                                ...
                                <th>
                                    <a class="list-sort text-muted" data-sort="item-title" href="#">Родительская категория</a>
                                </th>
                                <th></th>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Text -->
                                    <span class="item-title">{{$category->parent->name ?? '--'}}</span>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{route($route.'.edit', [$routeItem => $category])}}" class="dropdown-item">
                                                Редактировать
                                            </a>
